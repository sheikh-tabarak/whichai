...
const ToolCard = ({ tool, preview = false }) => {
        ...
        <>
            ...
            <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
                <div className="flex flex-col">
                    <span className="text-slate-400 text-[10px] uppercase font-bold tracking-tighter">Starting from</span>
    ...
    const containerClasses = `group relative flex flex-col w-full min-h-[420px] bg-slate-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-6 transition-all duration-500 overflow-hidden shadow-2xl ${preview ? '' : 'hover:scale-[1.02] hover:bg-slate-800/60 hover:border-white/20 cursor-pointer'}`;

...
const ToolCard = ({ tool }) => {
    ...
    return (
        ...
        <div className='relative border-gray border-[1px] min-h-[350px] min-w-[250px] max-w-[235px] rounded-md px-5 py-6 mb-8 text-center flex mx-auto lg:mx-4 '>
            ...
            <div className='space-y-5 text-center w-full'>
                ...
                <div className='flex-wrap flex gap-2 justify-center'>
                    {tool?.tags ? tool.tags.slice(0, 1).map((tag, key) => {
